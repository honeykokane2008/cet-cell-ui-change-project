...
const Topbar = () => {
    return (
        <div className='Topbar p-1 flex gap-2.5 justify-around items-center bg-(--background) border-transparent rounded-(--radius)'>
            ...
            <img className="h-8 w-auto" alt='satyamev-jayte-removebg-preview' src='https://cetcell.mahacet.org/wp-content/uploads/2025/01/satyamev-jayte-removebg-preview.png-1.webp'></img>

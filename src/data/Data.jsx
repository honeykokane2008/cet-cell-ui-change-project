...
export const logLinks = [
...

  {
    ...
    sub: "for A.Y2026-27",
    icon: (<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor">
...

  {
    ...
    sub: "for A.Y2026-27",
    icon: (<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor">

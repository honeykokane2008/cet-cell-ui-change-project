...
export const logLinks = [
...

  {
    ...
    path: "https://cetcell.mahacet.org/wp-content/uploads/2026/07/List-of-operative-centres-21072026.pdf"
  },
...
export const leadership = [
  {
    name: "Shri. Chandrakant Dada Patil",
    initial: "CP",
    designation: "Minister Higher & Technical Education"
  },
  {
    name: "Shri. Indranil Naik",
    initial: "IN",
    designation: " Minister of State Higher and Technical Education"
  },
  {
    name: "Shri. B Venugopal Reddy, IAS",
    initial: "VR",
    designation: "Chief Secretary Higher and Technical Education"
  },
  {
    name: "Shri. Dileep Sardesai, IAS",
    initial: "DS",
    designation: "Commisioner & Competent Authority, State CET CELL, Mumbai"
  }
]
...
export const team = [
  {
    Sr: 1,
    name: "Shri Dileep B. Sardesai, IAS",
    department: "",
    designation: "Commissioner & Competent Authority"
  },
  {
    Sr: 2,
    name: "Mr. Shrikant Madhavi",
    department: "Admin Department",
    designation: "Administrative Officer"
  },
  {
    Sr: 3,
    name: "Mrs. Ashwini Mundhe",
    department: "PA to Commissioner",
    designation: "Clerk"
  },
  {
    Sr: 4,
    name: "Mr. Kunal Deokar",
    department: "Technical Education",
    designation: "Asst. Exam Co-ordinator"
  },
  {
    Sr: 5,
    name: "Mrs.Nisha Wartha",
    department: "Technical Education",
    designation: "OSD"
  },
  {
    Sr: 6,
    name: "Mr. Moreshwar Bhalerao",
    department: "Technical Education",
    designation: "OSD"
  },
  {
    Sr: 7,
    name: "Dr. Shardul Gangan",
    department: "Agriculture Education",
    designation: "Exam Co-ordinator"
  },
  {
    Sr: 8,
  ...
  {
    Sr: 11,
    name: "Mr. Siddhesh Nar",
    department: "Medical Education",
    designation: "Exam Co-ordinator"
  },
  {
    Sr: 12,
    name: "Mrs. Shraddha More",
  ...
  {
    Sr: 14,
    name: "Mr. Arjun Holgunde",
    department: "IT Department",
    designation: "Programmer"
  },
  {
    Sr: 15,
    name: "	Mr. Manish Railkar",
    department: "IT Department",
    designation: "D.E.O."
  },
  {
    Sr: 16,
    name: "Mrs. Bharti Gerela",
  ...
  {
    Sr: 18,
    name: "Shri. Dattaram Asolkar",
    department: "Account Department",
    designation: "Clerk"
  },
  {
    Sr: 19,
    name: "Mrs. Pratiksha Shelke",
    department: "Account Department",
    designation: "Clerk"
  },
  {
    Sr: 20,
    name: "Mrs. Latika Mungekar",
    department: "Agriculture Education",
    designation: "Clerk"
  },
  {
  ...
  },
  {
    Sr: 25,
    name: "Mr. Sunil Bote",
    department: "ARA ( Technical)",
    designation: "Clerk"
  },
  {
    Sr: 26,
    name: "Mis. Vrushali Padave",
    department: "Higher Education",
    designation: "Clerk"
  },
  {
    Sr: 27,
    name: "Mr. Pankaj Patil",
    department: "Art Education",
    designation: "Clerk"
  },
  {
    Sr: 28,
    name: "Mrs. Reshma Karekar",
    department: "Legal Department",
    designation: "Clerk"
  },
]
